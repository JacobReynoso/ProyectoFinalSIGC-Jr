...
$db = db();
$items = $db->query("SELECT * FROM productos ORDER BY creado_en DESC")->fetchAll();

echo renderHeader('Uproductos','Gestiona todos los productos');
?>
...
<div class="card">
    <div class="card-header">
        <div>
            <h2>Lista de Uproductos</h2>
            <p>Total: <?php echo count($items); ?> Lproductos</p>
        </div>
    </div>
    <div class="card-content">
        ...
        <div class="empty-state">
            ...
            <h3>No hay Lproductos registrados</h3>
            <p>Comienza agregando tu primer Lproducto</p>
        </div>
        <?php else: ?>
        <table>
            <thead>
